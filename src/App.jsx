...
const WulfLandingPage = () => {
  ...
  return (
    <>
      ...
      <main>
        <section className="hero" id="inicio" aria-label="Seção inicial">
        ...
        <section className="about fade-in" id="sobre" aria-label="Sobre nós">
          ...
          <div className="about-content">
            <div className="about-text">
              ...
              <p>
                ...
                personalizados que não apenas impressionam visualmente, mas
                também geram resultados concretos para nossos clientes.
              </p>
              <p>
              ...
              <p>
                ...
                marketing digital, garantindo que cada projeto seja construído
            ...
            <div className="about-values">
              <div className="value-item">
                <h4>🎯 Missão</h4>
                <p>
                  Criar páginas que transformam visitantes em clientes através
                  de design excepcional e performance otimizada.
                </p>
              </div>
              <div className="value-item">
                <h4>💎 Valores</h4>
                <p>
                  Excelência, inovação, transparência e compromisso com
                  resultados mensuráveis para todos os nossos clientes.
                </p>
              </div>
              <div className="value-item">
                <h4>🚀 Visão</h4>
        ...
        <section className="services fade-in" id="servicos">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <p>
                Modernização completa de sites existentes com foco em
                performance, experiência do usuário e resultados mensuráveis.
              </p>
            </div>
            ...
            <div className="service-card">
              ...
              <p>
                Otimização técnica avançada garantindo carregamento ultra-rápido
                e excelente experiência em todos os dispositivos.
              </p>
            </div>
            ...
            <div className="service-card">
              ...
              <p>
                ...
                garantir uma presença digital sólida e de alto desempenho para
                sua marca.
              </p>
            </div>
            ...
            <div className="service-card">
              ...
              <p>
                Realizamos a instalação completa do seu site em qualquer
                provedor, garantindo que ele funcione de forma rápida, segura e
                estável desde o primeiro acesso.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="projects-grid">
            <div className="project-card">
              ...
              <div className="project-info">
                ...
                <p>
                  <strong>Desafio:</strong> Criar uma landing page envolvente
                  que atraísse novos alunos, apresentando o curso de costura de
                  forma clara e mostrando benefícios.
                </p>
                <a
            ...
            <div className="project-card">
              ...
              <div className="project-info">
                ...
                <p>
                  <strong>Desafio:</strong> Redesign completo da landing page
                  para destacar a qualidade do curso, reforçar a identidade da
                  escola e aumentar o número de inscrições.
                </p>
                <a
            ...
            <div className="project-card">
              ...
              <div className="project-info">
                ...
                <p>
                  ...
                  curso de programação, garantindo maior conversão de visitantes
                  e com layout moderno.
                </p>
                <a
